...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/1wMcTP8.gif",
...
Config.Languages = {
  ['en'] = {
        ...
        ['emotemenucmd'] = "Escribe /anim para abrir el menu.",
        ...
        ['doyouwanna'] = "~y~Y~w~ para aceptar, ~r~M~w~ para rechazar (~g~",
        ['refuseemote'] = "Animacion rechazada.",
        ['makenearby'] = "hacer que el jugador cercano juegue",
        ['camera'] = "Presione ~y~Z~w~ para usar el flash de la camara.",
        ['makeitrain'] = "Presiona ~y~Z~w~ para hacer llover.",
        ['pee'] = "Mantiene ~y~Z~w~ para mear.",
  },
  ['fr'] = {
        ['emotes'] = 'Emotes',
