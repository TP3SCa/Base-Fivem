...
ESX.RegisterServerCallback('cockatoos:getOnlinePlayers', function(source, cb)
...
ESX.RegisterServerCallback('cockatoos:setJob', function(source, cb, identifier, job, grade, type)
	local xPlayer = ESX.GetPlayerFromId(source)
	...
	if isBoss then
		...
		print(('cockatoos: %s attempted to setJob'):format(xPlayer.identifier))
		cb()
	end
end)

RegisterNetEvent('cockatoos:giveItem')
AddEventHandler('cockatoos:giveItem', function(itemName, amount)
	local xPlayer = ESX.GetPlayerFromId(source)

	if xPlayer.job.name ~= 'cockatoos' then
...
RegisterNetEvent('cockatoos:sellItem')
AddEventHandler('cockatoos:sellItem', function(itemName, amount, price)
	local xPlayer = ESX.GetPlayerFromId(source)
