...
ESX.RegisterServerCallback('vanilla:getOnlinePlayers', function(source, cb)
...
ESX.RegisterServerCallback('vanilla:setJob', function(source, cb, identifier, job, grade, type)
	local xPlayer = ESX.GetPlayerFromId(source)
	...
	if isBoss then
		...
		print(('vanilla: %s attempted to setJob'):format(xPlayer.identifier))
		cb()
	end
end)

RegisterNetEvent('vanilla:giveItem')
AddEventHandler('vanilla:giveItem', function(itemName, amount)
	local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterNetEvent('vanilla:sellItem')
AddEventHandler('vanilla:sellItem', function(itemName, amount, price)
	local xPlayer = ESX.GetPlayerFromId(source)
