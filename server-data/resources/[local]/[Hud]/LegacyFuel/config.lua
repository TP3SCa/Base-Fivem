...
Config.Strings = {
	...
	EToRefuel = "Presiona ~g~E ~w~para echar gasolina",
	JerryCanEmpty = "Bidon de gasolina vacio",
	FullTank = "Tanque lleno",
	PurchaseJerryCan = "Presiona ~g~E ~w~para comprar bidon de gasolina ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Presiona ~g~E ~w~para cancelar",
	CancelFuelingJerryCan = "Presiona ~g~E ~w~para cancelar",
	NotEnoughCash = "No tienes suficiente dinero",
	RefillJerryCan = "Presiona ~g~E ~w~para rellenar tu bidon de gasolina ",
	NotEnoughCashJerryCan = "No tienes suficiente dinero",
	JerryCanFull = "Bidon de gasolina lleno",
	TotalCost = "Coste",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona ~g~E ~w~para comprar un bidon de gasolina"
	Config.Strings.RefillJerryCan = "Presiona ~g~E ~w~para rellenar tu bidon de gasolina"
end
